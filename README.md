...
[Multimodal Generation / arXiv 2025]  
...
[Paper](https://arxiv.org/abs/2501.17811) · [PDF](https://arxiv.org/pdf/2501.17811) · [Issues](https://github.com/StaryMoon/Janus-Pro-Unofficial/issues) · [Release](https://github.com/StaryMoon/Janus-Pro-Unofficial/releases)
...
<p align="center">
  <img src="assets/paper-preview.png" alt="Janus-Pro-Unofficial paper or project page preview" width="900">
</p>

<sub>Image source: public paper/project page screenshot, [Paper](https://arxiv.org/abs/2501.17811). Captured/organized on 2026-07-02. This repository is unofficial and is not affiliated with the paper authors.</sub>
...
| Venue / Source | Multimodal Generation / arXiv 2025 |
| Focus | This repository organizes a PyTorch implementation for Janus-Pro: Unified Multimodal Understanding and Generation with Data and Model Scaling, focusing on unified multimodal und... |
...
This repository organizes a PyTorch implementation for **Janus-Pro: Unified Multimodal Understanding and Generation with Data and Model Scaling**, focusing on unified multimodal understanding and image generation with data and model scaling. The codebase is structured like a standard research repository so that model components, configuration files, scripts, and evaluation utilities can be extended independently.
...
```bash
git clone https://github.com/StaryMoon/Janus-Pro-Unofficial.git
cd Janus-Pro-Unofficial
python -m venv .venv
...
```python
import torch
from janus_pro_unofficial import ModelConfig, UnofficialModel, reconstruction_loss
...
```python
import torch
from janus_pro_unofficial import UnofficialModel
...
|---|---|---|
| Main quantitative comparison | Main paper tables | [arXiv paper](https://arxiv.org/abs/2501.17811) |
| Ablation study | Experiment / ablation sections | [arXiv paper](https://arxiv.org/abs/2501.17811) |
| Qualitative examples | Main paper figures and appendix | [arXiv PDF](https://arxiv.org/pdf/2501.17811) |
...
- Thanks to the authors of **Janus-Pro: Unified Multimodal Understanding and Generation with Data and Model Scaling** for the original research.
...
pytorch, unofficial-implementation, reproduction, janus-pro, multimodal-generation, vision-language, image-generation
